...
for prof in profNames:
    fileName = 'spell-ids-cata/' + prof + '.txt'
...
for prof in profSpellList:
    ...
    for spellID in prof:
        ...
        URL = 'https://www.wowhead.com/cata/spell=' + spellID
    ...
    spellDF.to_csv('spells-csv-cata/%s.csv' % (profNames[i]), header=True, index=False, sep='\t')
